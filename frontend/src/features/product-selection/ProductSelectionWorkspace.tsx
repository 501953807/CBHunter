...
export default function ProductSelectionPage() {
  return (
    <div className="scout-workflow-page product-selection-shell page-enter space-y-6">
      <ScoutStageRail activeStage="decision" />
      <div className="scout-workflow-main min-w-0 space-y-6">
        <section className="product-selection-hero rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-5 shadow-[var(--shadow-sm)]">
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <div className="grid grid-cols-3 gap-2 text-center text-xs">
              <div className="product-selection-status-tile rounded-xl border border-[var(--color-border)] bg-[var(--color-bg)] px-3 py-2">
