            ...
            <tr key={rowIndex}>
              {['sku', 'option_1_name', 'option_1_value', 'price', 'stock'].map(field => (
                <td key={field} className="py-1 pr-2">
                  <input
                    value={field === 'price' || field === 'stock' ? stringValue(variant[field]) : stringValue(variant[field])}
...
function MediaEditor({ draft, onChange }: { draft: BatchListingDraft; onChange: (patch: Partial<BatchListingDraft>) => void }) {
...
function LogisticsEditor({ draft, onChange }: { draft: BatchListingDraft; onChange: (patch: Partial<BatchListingDraft>) => void }) {
...
function ComplianceEditor({ draft, onChange }: { draft: BatchListingDraft; onChange: (patch: Partial<BatchListingDraft>) => void }) {
