...
const actionButtonClass = 'content-product-action rounded-full border border-[var(--color-border)] bg-[var(--color-bg)] px-3 py-1.5 text-xs font-semibold text-[var(--color-primary)] transition hover:border-[var(--color-primary)] hover:shadow-[var(--shadow-sm)] disabled:cursor-not-allowed disabled:opacity-40'
...
export function ListingCriticalActionStrip({
  ...
  return (
    <div data-ui="listing-critical-action-strip" aria-label="发布前关键操作" className="listing-critical-action-panel mt-3 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-3">
