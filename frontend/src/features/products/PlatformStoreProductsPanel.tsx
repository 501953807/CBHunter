...
import { getPlatformStoreProducts, type PlatformStoreProduct, type PlatformStoreProductFilterSummary } from '../../api/products'
import { getSyncLogs, triggerProductSync, type SyncBlockDetail, type SyncLogItem } from '../../api/sync'
...
function productSyncStatusLabel(status?: string | null) {
...
function buildPlatformStoreSummary(items: PlatformStoreProduct[], apiSummary?: PlatformStoreProductFilterSummary) {
...
function ProductSyncRetryLogBoard({ logs, isError, onRetry }: { logs: SyncLogItem[]; isError: boolean; onRetry: () => void }) {
